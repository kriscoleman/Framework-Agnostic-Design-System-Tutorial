  ...
  return (
    <main style={{ fontFamily: 'system-ui, sans-serif', padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <p>
        ...
        with <strong>Next.js's Link component</strong> injected for routing.
      </p>

      <section style={{ marginTop: '2rem' }}>
        <h2>Internal Navigation</h2>
        <p>These links use Next.js's prefetching and client-side routing:</p>
      ...
      <section style={{ marginTop: '2rem' }}>
        ...
        <AppLink
          ...
          onClick={() => alert('Button clicked! (Next.js App)')}
